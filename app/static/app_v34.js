...
(function voiceModule() {
  ...
  function renderVoiceGrid() {
    ...
    grid.querySelectorAll('.btn-rec-del').forEach(btn => {
      const hasRec = btn.dataset.has === '1';
      if (!hasRec) return;
    ...
    // Applica is-empty dove manca la registrazione
    grid.querySelectorAll('.btn-rec-del').forEach(b => {
      if (b.dataset.has !== '1') b.classList.add('is-empty');
